...
build_setup()
{
    ...
    git_submodule_update "${cwd}/boost-reports/boost_root" libs/conversion
    ...
    git_submodule_update "${cwd}/boost-reports/boost_root" libs/dynamic_bitset
    ...
    git_submodule_update "${cwd}/boost-reports/boost_root" libs/random
...
update_tools()
{
    ...
    "${cwd}/boost-reports/boost_bb/b2" "-j2" \
        "--boost-build=${cwd}/boost-reports/boost_bb/src" \
